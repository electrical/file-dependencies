...
describe FileDependencies do
  ...
  describe '.download' do
    ...
    let(:entries) { ['somefile2.txt', 'somefile3', 'some/file', 'some/other/file', 'other'] }

    let(:files) { [ { 'url' => url1, 'sha1' => sha1 }, { 'url' => url2, 'sha1' => sha2 }, { 'url' => url3, 'sha1' => sha3 } ] }
  ...
  describe '.process_vendor' do
    ...
    let(:files) { [ { 'url' => url1, 'sha1' => sha1 }, { 'url' => url2, 'sha1' => sha2 }, { 'url' => url3, 'sha1' => sha3 } ].to_json }
